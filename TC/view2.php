...
<center><h2>Enter Regno/Adno for Generate TC For 11th and 12th</h2></center>
<div id="d1">
<br><br>
<form name="myForm" method="post" action="Tc7-display.php" align="left" onsubmit="return validateForm()">
<table align="center">
